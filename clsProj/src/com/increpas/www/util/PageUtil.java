...
public class PageUtil {
	...
	private int startPage; // 해당 화면에서 보여질 이용 시작페이지
	private int endPage; // 해당 화면에서 보여질 마지막 페이지
	
	private int startCont; // 현재 페이지에서 보여줄 시작 게시물 로우넘버
	private int endCont; // 현재 페이지에서 보여줄 마지막 게시물 로우 넘버
	
	//총 페이지 수 계산 하는 함수
	public void calcPage() {
		/*
		  총 페이지 수는 총 게시물(totalCount) 수를 한 화면에 표시할 게시물 갯수(pageRow)
