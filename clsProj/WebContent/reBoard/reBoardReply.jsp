	...
	<div class="w3-content mxw2">
		...
		<div>
			...
			<div class="w3-col" style="margin-bottom: 0px;">
				<span class="w3-button w3-small w-100 w3-red w3-right dbtn" style="padding: 3px" id = "cbtn">취소</span>
				<span class="w3-button w3-small w-100 inblock  w3-blue w3-right rbtn" style="padding: 3px" id="sbtn">댓글</span>
			</div>
		</div>
