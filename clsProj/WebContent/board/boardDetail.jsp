...
<script type="text/javascript">
	$(document).ready(function(){
		$('#home').click(function(){
				location.href = '/clsProj/main/main.cls';
		});
		$('#list').click(function(){
			$('#frm').submit();
		});
...
<body>
	<form method="post" action="/clsProj/board/board.cls" id="frm">
				...
				<input type="hidden" name="click" id="click" value="${DATA.click}">
				<input type="hidden" name="sdate" id="sdate" value="${DATA.sdate}">
